...
class DiscoverController extends GetxController {
  ...
  List<Map<String, String>> listOfCharacters = [
    {'image': ImagePathNetwork.image4, 'name': "Richmond"},
  ...
  List<Map<String, dynamic>> notificationList = [
    {
      ...
      'name': "Dog Attack: Dog attack on child in Thane, Mumbai"
    },
    {
  ...
  /// Insight List
  List<Map<String, dynamic>> insightList = [
    {'image': ImagePathNetwork.dog1},
  ...
  List<Map<String, dynamic>> pollList = [
    {
      ...
      'name': "Dog Attack: Dog attack on child in Thane, Mumbai",
      'description':
          "These days, cases of dog attacks are coming to the fore. Recently, a stray dog ​​attacked a child in Noida, due to which he died. Now a case of dog attack has come to light from Mumbai. Watch this report. "
    },
    {
      'image': ImagePathNetwork.dog1,
      'name':
          "Asked to put ‘Dog’ in a pet carrier, passenger throws bottle at fellow flyer",
      'description':
          "A female passenger travelling on a Delta Airline plane with her pet dog got angry when asked to place the dog in a special carrier bag for pets and threw bottle at a fellow flyer. "
    },
    {
      'image': ImagePathNetwork.dog2,
      'name': "Dog Attack: Dog attack on child in Thane, Mumbai",
    ...
    },
    {
      ...
      'name':
          "Viral Video: Pet Dog goes Paragliding with owner, netizens react- WATCH",
      'description':
          "When internet users saw that the dog appeared to be terrified, they became upset The video has crossed over 1.4 million views since it was shared The pair paragliding was included in a few wide Instagram Reels photos"
    },
    {
    ...
    },
    {
      ...
      'description':
          "n 2013, Bo was joined at the White House by a second Portuguese water dog, Sunny, after Michelle Obama said that Bo needed more interaction with other dogs, according to NYT."
    }
  ];

  /// Topic List Items
  List<Map<String, dynamic>> topicList = [
    {'image': ImagePathNetwork.dog8, 'name': "Health"},
  ...
  void onInit() {
    ...
    pageController = PageController(
        initialPage: currentPage.value, viewportFraction: viewPortFraction);
    pageController.addListener(() {
      if (topicNotificationPageController.page!.floor() !=
          pageController.page!.floor()) {
        topicNotificationPageController.animateToPage(
            pageController.page!.floor(),
            duration: Duration(milliseconds: 300),
            curve: Curves.easeInCubic);
      }
    });
    topicNotificationPageController =
        PageController(initialPage: currentPage.value);
  }

  getScale(int index) {
    scale.value = max(SCALE_FRACTION,
        (FULL_SCALE - (index - page.value).abs()) + viewPortFraction);
    return scale;
  }
